...
namespace Application.Tests.Services
{
    public class IntegrationServiceTests
    {
        ...
        [Fact]
        public async Task UpdateAsyncShouldReturnInvalidDataWhenIntegrationDescriptionExceedsMaxLength()
        {
            // Arrange
            var integration = new Integration("Name", new string('A', 256));
            // Act
        ...
        [Fact]
        public async Task UpdateAsyncShouldReturnInvalidDataWhenIntegrationNameExceedsMaxLength()
        {
            // Arrange
            var integration = new Integration(new string('A', 256), "Description");
            // Act

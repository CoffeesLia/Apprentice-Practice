...
namespace WebApi.Tests.Controllers
{
    public class ApplicationDataControllerTest
    {
        ...
        public async Task ExportCsvShouldReturnFileContentResultWithCsvContentType()
        {
            ...
            Assert.Contains("applications_", fileResult.FileDownloadName, StringComparison.CurrentCulture);
            Assert.EndsWith(".csv", fileResult.FileDownloadName, StringComparison.CurrentCulture);
        }
        ...
        public async Task ExportPdfShouldReturnFileContentResultWithPdfContentType()
        {
            ...
            Assert.Equal(expectedBytes, fileResult.FileContents);
            Assert.Contains("applications_", fileResult.FileDownloadName, StringComparison.CurrentCulture);
            Assert.EndsWith(".pdf", fileResult.FileDownloadName, StringComparison.CurrentCulture);
        }
        ...
        public async Task ExportSinglePdfShouldReturnFileContentResultWithPdfContentTypeAndIdInFileName()
        {
            ...
            Assert.Equal("application/pdf", fileResult.ContentType);
            Assert.Equal(expectedBytes, fileResult.FileContents);
            Assert.Contains($"application_{id}_", fileResult.FileDownloadName, StringComparison.CurrentCulture);
            Assert.EndsWith(".pdf", fileResult.FileDownloadName, StringComparison.CurrentCulture);
        }

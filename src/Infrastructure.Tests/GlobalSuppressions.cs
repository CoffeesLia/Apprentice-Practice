...
[assembly: SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "The class is only tests.", Scope = "member", Target = "~P:Infrastructure.Tests.Data.Repositories.RepositoryBaseTests.TestEntity.Nodes")]
[assembly: SuppressMessage("Design", "CA1034:Nested types should not be visible", Justification = "The class is only tests.", Scope = "type", Target = "~T:Infrastructure.Tests.Data.Repositories.RepositoryBaseTests.TestEntityNode")]

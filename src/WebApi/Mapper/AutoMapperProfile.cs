...
namespace Stellantis.ProjectName.WebApi.Mapper
{
    internal class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMapForApplication();
            CreateMapForArea();
            CreateMapForIntegration();
            CreateMapForMember();
            CreateMapForSquad();
            CreateMapForRepository();
            CreateMapForResponsible();
            CreateMapForServiceData();
        }

        private void CreateMapForApplication()
        {
        ...
        private void CreateMapForIntegration()
        {
        ...
        private void CreateMapForRepository()
        {
        ...
        private void CreateMapForResponsible()
        {
        ...
        private void CreateMapForServiceData()
        {
        ...
        private void CreateMapForSquad()
        {
